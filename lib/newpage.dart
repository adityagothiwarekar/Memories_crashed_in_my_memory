...
import 'package:share_extend/share_extend.dart'; // Import Memory from database.dart
...
class MemoryCard extends StatelessWidget {
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              await _shareMemory(memory.imagePath); // Pass imagePath to _shareMemory
            },
  ...
  Future<void> _shareMemory(String imagePath) async {
    try {
      await ShareExtend.share(imagePath, "image"); // Share the image using share_extend
    } catch (e) {
